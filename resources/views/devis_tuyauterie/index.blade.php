                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50/50 dark:bg-gray-900/50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Chargé d'affaires</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($devis as $item)
                                        <tr class="hover:bg-amber-50/30 dark:hover:bg-gray-700/50 transition duration-150 ease-in-out group cursor-pointer" onclick="window.location='{{ route('devis_tuyauterie.show', $item->id) }}'">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($item->chargesAffaire->isNotEmpty())
                                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-200">
                                                        {{ $item->chargesAffaire->first()->first_name }} {{ $item->chargesAffaire->first()->last_name }}
                                                    </div>
                                                @else
