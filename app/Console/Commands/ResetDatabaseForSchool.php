...
use Database\Seeders\school\DatabaseSchoolSeeder;

class ResetDatabaseForSchool extends Command
{
    protected $signature = 'db:set-up-database-school';
    protected $description = 'supprime toutes les tables de la base de données et les re créer pour les epreuves de bts';
    ...
    public function handle(): void
    {
        ...
        $this->call(DatabaseSchoolSeeder::class);
        $fin = microtime(true);
